...
def main(argv=None):
    ...
    bim_params = {"eps": 0.3, "eps_iter": 0.05, "nb_iter": 10, "clip_min":0., "clip_max":1.}
    # SaliencyMapMethod
    jsma_params = {"theta": 1, "gamma": 0.5, "clip_min": 0., "clip_max": 1.}
    # DeepFool
    ...
    # MadryEtAl/PGD
    madry_params = {"eps": 0.3, "eps_iter": 0.01, "nb_iter": 40,
                    "clip_min": 0., "clip_max": 1.}
    # MomentumIterativeMethod
    mim_params = {"eps": 0.3, "eps_iter": 0.06, "nb_iter": 10, "decay_factor": 1.0,
                  "clip_min": 0., "clip_max": 1.}

    attack(datadir="./data/mnist/",
           train_start=0, train_end=60000, test_start=0, test_end=128,
           batch_size=128,
           AttackMethod=CarliniWagnerL2,
           attack_params=cwl2_params,
           is_targeted=True,
           savedir="./data/mnist/CWL2")
